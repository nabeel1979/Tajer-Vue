        ...
        <div class="show_table">
          ...
          <div class="row_section">
            ...
            <div class="cell_right_6" style="border-bottom: none;">
                ...
                <p>the undersigned hereby declaes that the above details and statements are correct; that all the goods were produced in</p>
                <hr style="border: none; border-bottom: 2px dashed black;">
                <p style="padding: 10px; text-align: center;">(country)</p>
                <p style="text-align: center;">and that they comply with the orgin requirements specified for those goods in the Generailzed System of Preferences for goods exported to .</p>
                <hr style="border: none; border-bottom: 2px dashed black;">
                <p style="padding: 10px; text-align: center;">(importing country)</p>
                <hr style="border: none; border-bottom: 2px dashed black;">
